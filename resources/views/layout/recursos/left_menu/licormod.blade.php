...
<form>
  ...
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link" href="licorreg.blade.php#">Registrar</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="licormod.blade.php#">Modificar</a>
      </li>
      <li class="nav-item">
  ...
  <div class="card-body text-left">
    ...
    <label for="lab_cod_licor" class="col-sm-2 col-form-label">Código de Licor:</label>
    <div class="col-sm-3">
      <input type="number" class="form-control" placeholder="" name="txt_cod_licor">
    </div>
